...
<div>
    ...
    <div
        className="bg-linear-to-t from-[#24437A] to-[#A8DBFA] p-6 rounded shadow flex items-center justify-between mb-6">
        <div className="flex w-full justify-between items-center">
            <img src={gambar2} alt="" />
            <div className="flex flex-col items-center">
                <h2 className="text-2xl font-semibold text-white">Hi, Tolak Ivandi Yudistiawan</h2>
                <p className="text-xl text-white">3122522020</p>
                <h3 className="text-lg text-white">TOEFL Application for Student to Improve Their Knowledgw in English
                </h3>
            </div>
    ...
    <CardContent className={`flex flex-col items-start`}>
        ...
        <div className="flex flex-col items-center">
            <Button className="bg-[#A8DBFA] py-7 px-7 rounded-lg shadow-md hover:bg-[#76B7E4]">
                <div
                    className="bg-[rgba(63,162,246,0.3)] p-6 rounded-full flex hover:bg-[rgba(63,162,246,0.5)] items-center justify-center">
        ...
        <div className="flex flex-col items-center mb-6">
            <div className="relative w-32 h-32">
                <svg className="w-full h-full" viewBox="0 0 36 36">
                    <circle className="text-gray-300" strokeWidth="3.8" stroke="currentColor" fill="transparent" r="16"
                        cx="18" cy="18" />
                    <circle className="text-purple-500" strokeWidth="3.8" strokeDasharray="25, 100"
                        strokeLinecap="round" stroke="currentColor" fill="transparent" r="16" cx="18"
                        cy="18" />
                    <circle className="text-yellow-500" strokeWidth="3.8" strokeDasharray="20, 100"
                        strokeLinecap="round" stroke="currentColor" fill="transparent" r="16" cx="18"
                        cy="18" />
                    <circle className="text-green-500" strokeWidth="3.8" strokeDasharray="15, 100" strokeLinecap="round"
                        stroke="currentColor" fill="transparent" r="16" cx="18" cy="18" />
                </svg>
